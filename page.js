...
function Fish({ name, color, swimDuration, swimDelay, topOffset, pitch, playBlub }) {
...
export default function AcquaCalc() {
  ...
  return (
    ...
    >
      ...
      <Fish name="Didi" color={COLORS.mint} swimDuration={28} swimDelay={0} topOffset="16%" pitch={0.7} playBlub={playBlub} />
      <Fish name="Gogo" color={COLORS.wood} swimDuration={34} swimDelay={-9} topOffset="27%" pitch={0.3} playBlub={playBlub} />
